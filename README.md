...
* 🎓 **M.Sc. in ICT Candidate** at Mawlana Bhashani Science and Technology University.
* 🔬 **Current Thesis:** *A Rubric-Based Cross-Lingual Benchmark for Evaluating LLMs in English and Bangla ICT Education*
* 💼 **Industry Experience:** Engineering automated Python data extraction pipelines and AI implementations for UK-based enterprise systems
* 🎯 **Interests:** Multimodal AI, Explainable AI (XAI), Medical Image Segmentation/Classification, Cross-Lingual NLP
...
- **Detection and Classification of Kidney Disease from CT Images: An Automated Deep Learning Approach**  
  *Technologies (MDPI)*, Vol. 13, Iss. 11, 2025.  
  *Deep learning architectures for automated renal pathology classification.*

- **Classification of Kidney Disease from CT Images: A Deep Learning-Based Comparative Analysis**  
  *IEEE 9th International Conference on Software Engineering & Computer Systems (ICSECS 2025)*. 

- **AlzCNN: A Custom CNN Architecture for Alzheimer's Stage Detection from MRI Images**  
  *IEEE 9th International Conference on Software Engineering & Computer Systems (ICSECS 2025)*.
